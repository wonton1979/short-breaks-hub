...
export default function WeatherDetailsCard({currentWeatherData,isCelsius,displayWeatherData,isFutureDateSelected}) {
    return (
        <div className="p-5 bg-white">
            ...
            <div className="mt-3 flex items-end gap-2">
                <p className="text-4xl font-bold text-gray-900">{displayWeatherData?.currentTemperature && (
            ...
            <div className="mt-5 grid grid-cols-2 gap-y-3 text-sm text-gray-700">
                ...
                <div className="flex items-center gap-2">
                    💨 <span>Wind {displayWeatherData?.windSpeed && (
                ...
                <div className="flex items-center gap-2">
                    🌅 <span>Sunrise {displayWeatherData?.sunrise && (
