...
export default function WeatherHourlySummary ({time,emoji,temperature,isCelsius}){
    return (
        <div className="w-16 shrink-0 rounded-lg border border-slate-200 p-2 text-center mb-3">
